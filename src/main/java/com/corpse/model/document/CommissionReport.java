...
@Entity
@Table(name = "commission_reports", schema = "public")
@DynamicInsert
public class CommissionReport extends Document {

	private static final long serialVersionUID = -4827955459375875655L;
